...
john = User.new({
  ...
  first_name: "John",
  last_name: "Doe",
  address: "5 rue du puy, 44000 nantes"
  })
...
alexis = User.new({
  ...
  first_name: "Alexis",
  last_name: "Bou",
  address: "127 rue principale, 75000 paris"
  })
...
henry = User.new({
  ...
  first_name: "Henry",
  last_name: "Quatre",
  address: "5 rue du sable, 49100 Saumur"})
...
doudou = User.new({
  ...
  first_name: "Doudou",
  last_name: "Soirée",
  address: "13 rue du sorcier, 44300 nantes"})
...
chuck = User.create({
  ...
  first_name: "Chuck",
  last_name: "Norris",
  address: "11 rue du puygarniers, 49000 Angers"})
...
martin = User.new({
  ...
  first_name: "Martin",
  last_name: "Du Matin",
  address: "11 rue du fort, 44000 nantes"})
